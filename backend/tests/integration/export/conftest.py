"""Directory-local PostgreSQL 17 harness for the public dataset export boundary."""
...
def postgres_base_url() -> Iterator[str]:
    ...
    with PostgresContainer(
        ...
        "67870dc097790edf2bd6726658db995dcc830f799d41bb2b78ef07c9a2d5f010",
        driver="asyncpg",
    ) as postgres:
